...
from gen_planner.python.src.func_zones.zones import FuncZone, basic_gen_plan
...
class GenPlanner:
    ...
    def zone2block(self, polygon: Polygon,func_zone: FuncZone) -> GeoDataFrame:
        pass

    def terr2zone2block(self, polygon: Polygon, scenario:basic_gen_plan) -> GeoDataFrame:
        pass
